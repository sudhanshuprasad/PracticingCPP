...
//     for(int i=0;i<int(sizeof(grades));i++){
//         if (grades[i]>38) {
//             if((grades[i]%5)+1==0){
...
//     vector<int> originalGrades, finalGrades;
// 	originalGrades={23,34,45,56,78,66};
//     finalGrades=gradingStudents(originalGrades);
//     // cout<<"check";
//     // for (int i=0; i<6; i++){
//     //     cout<<finalGrades.at(i)<<" ";
//     // }
